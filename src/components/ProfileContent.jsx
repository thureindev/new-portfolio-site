        ...
        <main className='max-w-2xl lg:mt-20 flex flex-col items-start justify-center flex-1 pl-8 pr-8 md:px-20 text-base text-justify'>
          <RoughNotationGroup show={true}>
            ...
            <p className='mb-4 indent-8'>
              An enthusiastic builder, learner, and teacher, My strong
              foundation in computing and business management complements my
              hands-on experience in web development and teaching.
            </p>
            ...
            <p className='mb-4 indent-8'>
              ...
              &nbsp; has equipped me to understand and adapt to diverse coding
              environments, My proficiency extends to &nbsp;
              <RoughNotation
                type='circle'
                color='#37B9F2'
                order='5'
          ...
          <div className='flex space-x-4'>
            <ProfileSocialLink
              text={false}
              href={'https://www.linkedin.com/in/thureindev/'}
              isTargetBlank={true}
              icon={<FaLinkedinIn className='h-6 w-6' aria-hidden='true' />}
            />

            <ProfileSocialLink
              text={false}
              href={'https://www.github.com/thureindev/'}
              isTargetBlank={true}
              icon={<FiGithub className='h-6 w-6' aria-hidden='true' />}
            />
